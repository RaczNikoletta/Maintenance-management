...
@Provider
@JwtOperator
public class JwtOperatorFilter implements ContainerRequestFilter{
    @Override
    public void filter(ContainerRequestContext requestContext) throws IOException {
        ...
        try {
            ...
            if(jwt.getClaim("role").asString().equals(Constants.UserRoles.ADMIN) || jwt.getClaim("role").asString().equals(Constants.UserRoles.OPERATOR)){

...
@Provider
@JwtEszkozfelelos
public class JwtEszkozfelelosFilter implements ContainerRequestFilter{
    @Override
    public void filter(ContainerRequestContext requestContext) throws IOException {
        ...
        try {
            ...
            if(jwt.getClaim("role").asString().equals(Constants.UserRoles.ADMIN) || jwt.getClaim("role").asString().equals(Constants.UserRoles.ESZKOZFELELOS)){
